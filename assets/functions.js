...
function getLanguageImageTag(language) {

    var output = "";

    switch (language) {
        case "bash":
            // @see https://commons.wikimedia.org/wiki/File:Bash_Logo_Colored.svg
            output = '<img src="https://upload.wikimedia.org/wikipedia/commons/4/4b/Bash_Logo_Colored.svg" />';
            break;
        case "c":
            // @see https://konpa.github.io/devicon
        ...
        case "rust":
            ...
            output = '<img src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Rust_programming_language_black_logo.svg" />';
            break;
        default:
            output = "";
    }
